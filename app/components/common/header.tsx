...
export default function Header( props: { title: string } ) {
  ...
  return (
    <header className="text-xl md:text-base bg-[#2e3436] w-screen z-50 flex py-1 px-3 justify-between fixed">
      <div id="session-id" className="float-left text-[#4E9A06]">
        <p>
      ...
      <div id="timer" className="text-[#84A87F]">
        [ { curTime } ]
      </div>
    </header>
  );
